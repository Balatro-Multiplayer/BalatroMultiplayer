...
-- separate bridge GameModes in pvp_api/gamemodes.lua (keys like "pvp_chocolate").
...
-- rulesets/_rulesets.lua's PVP.Ruleset.

PVP.Gamemodes = MPAPI.GameModes

local function noop_start_run() end

function PVP.Gamemode(init)
