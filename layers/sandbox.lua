...
--- Randomly selects one idol variant to be available in the sandbox layer
--- Bans the other idol variants to ensure only one is available per game
...
local sandbox_reworked_jokers = (function()
	local jokers = {}
	local idol_jokers = {}
