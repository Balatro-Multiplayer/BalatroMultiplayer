...
SMODS.Joker({
	...
	loc_vars = function(self, info_queue, card)
		...
		return {
			vars = {
				...
				G.GAME.skips ~= nil and PVP.GAME.enemy.skips ~= nil and localize({
					type = "variable",
	...
	update = function(self, card, dt)
		if G.STAGE == G.STAGES.RUN and G.GAME.skips ~= nil and PVP.GAME.enemy.skips ~= nil then
			local skip_diff = (math.max(G.GAME.skips - PVP.GAME.enemy.skips, 0))
