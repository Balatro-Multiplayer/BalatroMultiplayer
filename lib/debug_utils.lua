...
-- water is wet
function PVP.UTILS.log_mem_debug_messages()
	-- respect opt-out
	if PVP.EXPERIMENTAL.mem_debug then
		...
		if PVP._DEBUG_PANIC_COLLECTS then
			sendDebugMessage("nuGC panic collects: "..PVP._DEBUG_PANIC_COLLECTS, "MULTIPLAYER")
		end
	end
end