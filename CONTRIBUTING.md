...
**Prerequisites**: Install [Steamodded 1.0.0~BETA-1620a](https://github.com/Steamodded/smods/releases/tag/1.0.0-beta-1620a) and [Lovely Injector](https://github.com/ethangreen-dev/lovely-injector) (>=0.9)
