...
return {
	...
	misc = {
		...
		dictionary = {
			...
			b_start_lobby = "Lancer la partie", -- Inutilisé
			b_ready = "Prêt",
			b_unready = "Pas prêt",
			...
			b_toggle_jokers = "Basculer les Jokers",
			...
			k_total_lives_lost = " Vies perdues ($4 chacune)",
			k_comeback_money_sandbox = " Compensation ($3 × mise initiale)",
