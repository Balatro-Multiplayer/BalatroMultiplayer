...
return {
	...
	misc = {
		...
		dictionary = {
			...
			k_chocolate_ranked = "Стандартный рейтинг",
			k_chocolate_ranked_description = "Официальные соревновательные правила.\n\nСтандартные правила с заблокированными настройками:\n- Режим игры: Истощение\n- The Order включён\n- Требуется рекомендуемая версия Steamodded",
			...
			k_experimental_chocolate = "Экспериментальный (Стандартный)",
			...
			k_show_mp_content_anyway = "Скрыть контент мультиплеера*",
