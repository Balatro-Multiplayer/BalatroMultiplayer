...
return {
	...
	misc = {
		...
		dictionary = {
			...
			k_experimental_chocolate = "Thử Nghiệm (Tiêu Chuẩn)",
			...
			k_show_mp_content_anyway = "Ẩn nội dung Multiplayer*",
