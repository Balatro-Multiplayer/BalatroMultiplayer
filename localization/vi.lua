...
return {
	...
	misc = {
		...
		dictionary = {
			...
			mp_blind_raiser_tooltip_title = "Nâng Cấp Blind",
			mp_blind_raiser_tooltip_upgrades = "Số Blind đã nâng cấp: #1#",
			mp_blind_raiser_tooltip_score = "Điểm sau khi nâng cấp: #1#",
			k_bl_death = "Chết",
