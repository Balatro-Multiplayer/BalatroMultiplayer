return {
	...
	misc = {
		...
		dictionary = {
			...
			k_chocolate_ranked = "Chocolate Ranked",
			k_chocolate_ranked_description = "The official competitive ruleset.\n\nChocolate ruleset with locked settings:\n- Attrition gamemode\n- The Order enabled\n- Requires recommended Steamodded version",
			...
			k_experimental_chocolate = "Experimental (Chocolate)",
			k_experimental_description = "Chocolate's bleeding edge.\n\nHeavier balance changes being trialed\nfor a future Chocolate ruleset.\n\n(See bans and reworks tabs for details)",
			...
			k_show_mp_content_anyway = "Show Multiplayer content anyway*",
