return {
	...
	misc = {
		...
		dictionary = {
			...
			b_sc_join_clipboard = "Join from Clipboard",
			b_sc_join_lobby = "Join Lobby",
			b_sc_create_lobby = "Create Lobby",
			b_sc_copy_code = "Copy Lobby Code",
			b_sc_view_code = "View Lobby Code",
			b_sc_leave_lobby = "Leave Lobby",
			b_sc_reconnect = "Reconnect",
			b_sc_lobby_info = "Lobby Info",
