return {
	...
	misc = {
		...
		dictionary = {
			...
			mp_blind_raiser_tooltip_title = "Blind Raiser",
			mp_blind_raiser_tooltip_upgrades = "Blind upgrades this game: #1#",
			mp_blind_raiser_tooltip_score = "Score if upgraded: #1#",
			k_bl_death = "Death",
