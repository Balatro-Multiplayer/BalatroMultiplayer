...
-- Paired with the vanilla G.FUNCS.wipe_on(); continue_in_singleplayer below is the sole
-- caller. Standalone — only vanilla globals (G.screenwipe, G.E_MANAGER, Event).
