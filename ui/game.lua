...
function MP.end_round()
	if MP.stop_ends then sendDebugMessage('Double-end prevented'); return end -- Certain cases cause the game to end multiple times, this ensures the calculation happens once.
	MP.stop_ends = true
