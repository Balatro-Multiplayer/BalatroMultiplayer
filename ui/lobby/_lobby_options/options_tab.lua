...
function MP.UI.create_lobby_options_tab()
	return {
		...
		nodes = {
			...
			create_lobby_option_toggle("random_deck_toggle", "b_opts_random_deck", "random_deck"),
			create_lobby_option_toggle("random_stake_toggle", "b_opts_random_stake", "random_stake"),
